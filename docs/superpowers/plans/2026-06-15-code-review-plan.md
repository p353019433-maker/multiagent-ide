...
**Agent 1 — 安全**
```
目标：对 /Users/nothingfear/Desktop/自制ide/src/ 全量做安全审查。
重点关注：
...
**Agent 2 — 性能**
```
目标：对 /Users/nothingfear/Desktop/自制ide/src/ 全量做性能审查。
重点：
...
**Agent 3 — 架构**
```
目标：对 /Users/nothingfear/Desktop/自制ide/src/ 全量做架构审查。
重点：
...
**Agent 4 — 代码质量**
```
目标：对 /Users/nothingfear/Desktop/自制ide/src/ 全量做代码质量审查。
重点：
...
**Agent 5 — 测试覆盖**
```
目标：对 /Users/nothingfear/Desktop/自制ide/src/ 评估测试覆盖。
...
**Agent 6 — 可维护性**
```
目标：对 /Users/nothingfear/Desktop/自制ide/src/ 做可维护性审查。
重点：
