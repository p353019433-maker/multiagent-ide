...
export default function MainLayout({ onOpenSettings, settingsVersion, shortcutsDisabled }: Props) {
  ...
  const paletteCommands: PaletteCommand[] = [
    ...
    { id: 'githubSettings', label: '打开设置: GitHub / 外部服务', keywords: 'github token external', run: () => onOpenSettings('github') },
    { id: 'safetySettings', label: '打开设置: 安全与审批', keywords: 'safety approval mode', run: () => onOpenSettings('safety') },
    { id: 'advancedSettings', label: '打开设置: 高级 / 诊断', keywords: 'advanced diagnostics version reload', run: () => onOpenSettings('advanced') },
